              ...
              <div className="d-flex align-items-center mb-4 pt-2">
                ...
                >
                  <div className="input-group-btn">
                    <button
                      disabled={itemExist?.quantity <= 1 ? true : false}
                      className="btn btn-primary btn-minus"
                      onClick={() => handleDecQuantity(data)}
                    >
                  ...
                  <input
                    ...
                    value={itemExist ? itemExist.quantity : "1"}
                  />
                  <div className="input-group-btn">
                    <button
                      className="btn btn-primary btn-plus"
                      onClick={() => handleIncQty(data)}
                    >
                ...
                {itemExist ? (
                  <button className="btn btn-primary px-3" disabled>
                    <i className="fa fa-shopping-cart mr-1"></i> Already in Cart
                  </button>
                ) : (
                  <button
